...
1. Clone the repository:
   ```bash
   git clone https://github.com/Kontusss/Biochat.git
   cd Biochat/biochat_env
   ```
...
3. Lastly, to activate the biochat environment:
```bash
...
```bash
conda activate biochat_py310
```

### 📦 Langchain Package Support

The Biochat environment comes with a minimal set of langchain packages by default:
