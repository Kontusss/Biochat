...
**Location**: `biochat/knowledge/docs/resource/addgene_grna_sequences.csv`
...
Use `advanced_web_search_claude` from `biochat.tool.literature` to find validated sgRNAs from literature and databases:

```python
from biochat.tool.literature import advanced_web_search_claude
...
**All 238 download links are available in**: `biochat/knowledge/docs/resource/CRISPick_download_links.txt`
...
grep "9606_GRCh38_SpyoCas9_CRISPRko" biochat/knowledge/docs/resource/CRISPick_download_links.txt

# Or for mouse
grep "10090_GRCm38_SpyoCas9_CRISPRko" biochat/knowledge/docs/resource/CRISPick_download_links.txt
```
