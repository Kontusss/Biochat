...
The registry is the successor to the upstream ``biochat/know_how/loader.py``.
...
from biochat.knowledge.source import KnowledgeSource
    ...
    def __init__(self, docs_dir: str | None = None, loaders: list | None = None):
        ...
        Args:
            docs_dir: Directory scanned for ``*.md`` documents.  Defaults to
                      the bundled ``biochat/knowledge/docs``.
