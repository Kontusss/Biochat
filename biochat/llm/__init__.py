...
Replaces the monolithic ``biochat/llm.py`` with a modular architecture:
...
from biochat.llm.factory import create_llm, get_llm
from biochat.llm.types import ALLOWED_SOURCES, SourceType
