...
class ConversationMarkdownBuilder:
    ...
    def __init__(self, agent: "A1", include_images: bool = True) -> None:
        ...
        self._content: list[str] = ["# Biochat Agent Conversation History\n\n"]
    ...
    def _format_content(self, text: str) -> str:
        ...
        from biochat.utils.text_format import format_checkbox_lists, render_execute_tags_as_html

        text = format_checkbox_lists(text)

        def _parse_tools(code: str) -> list[tuple[str, str]]:
            from biochat.utils.tool_parser import detect_tool_imports_with_modules
