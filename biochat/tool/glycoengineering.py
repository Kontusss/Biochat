...
Functions return research-log style strings to match Biochat tool patterns.
"""
...
def list_glycoengineering_resources() -> str:
    ...
    lines.append("- For tight Biochat integration, consider adding MCP wrappers or CLI installers.")
    return "\n".join(lines)
