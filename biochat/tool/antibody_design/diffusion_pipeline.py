...
def load_diffusion_model(model_dir: Optional[str] = None, device: str = "auto") -> Dict[str, Any]:
    ...
    from biochat.tool.antibody_design.model_inference import load_pretrained_model
...
def generate_cdrh3_candidates(
    ...
    from biochat.tool.antibody_design.model_inference import generate_cdrh3 as _generate
