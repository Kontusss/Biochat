...
def filter_cdrh3_design(
    cdrh3: str,
    epitope: str,
    preferred_min_len: int = 13,
    preferred_max_len: int = 16,
    allowed_min_len: int = 6,
    allowed_max_len: int = 26,
    ...
    if aromatic_frac > 0.30:
        flags.append("high_aromatic_fraction")

    # Single aromatic > 0.25
    for aa in AROMATIC:
