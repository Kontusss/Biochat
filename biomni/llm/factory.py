...
Usage::
    ...
    from biomni.llm.factory import create_llm
...
from biomni.llm.providers import PROVIDER_REGISTRY
from biomni.llm.source_detector import detect_llm_source
...
def create_llm(
    ...
    *,
    legacy_config: "BiomniConfig | None" = None,
    config: "BiomniConfig | None" = None,  # backward-compat alias for legacy_config
) -> BaseChatModel:
    ...
    Args:
        ...
        legacy_config: Optional ``BiomniConfig`` for backward compatibility.
...
# Keep the original function name available so existing ``from biomni.llm
