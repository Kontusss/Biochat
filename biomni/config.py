"""
Biochat Configuration Management (Biomni-compatible)
...
# biomni.agent (which also calls load_dotenv) hasn't been imported yet.
try:
...
@dataclass
class BiomniConfig:
    """Central configuration for Biochat agent (Biomni-compatible).
...
def _sync_legacy_to_new() -> None:
    ...
    try:
        from biomni.core.settings import biochat_settings as _new
