...
**Location**: `biomni/knowledge/docs/resource/addgene_grna_sequences.csv`
...
**All 238 download links are available in**: `biomni/knowledge/docs/resource/CRISPick_download_links.txt`
...
grep "9606_GRCh38_SpyoCas9_CRISPRko" biomni/knowledge/docs/resource/CRISPick_download_links.txt

# Or for mouse
grep "10090_GRCm38_SpyoCas9_CRISPRko" biomni/knowledge/docs/resource/CRISPick_download_links.txt
```
