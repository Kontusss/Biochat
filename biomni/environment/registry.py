...
Replaces the two parallel upstream dict modules (``biomni/env_desc.py``
full view, ``biomni/env_desc_cm.py`` commercial view) with one catalog plus
...
from biomni.environment.loader import load_catalog
from biomni.environment.schema import CatalogEntry
